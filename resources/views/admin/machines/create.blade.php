        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Enter machine information</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('machines.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="machine_type" value="{{ old('machine_type') }}"
                                       class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="machine_status" class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    <option value="working" {{ old('machine_status') == 'working' ? 'selected' : '' }}>Working</option>
                                    <option value="under_maintenance" {{ old('machine_status') == 'under_maintenance' ? 'selected' : '' }}>Under Maintenance</option>
                                    <option value="inactive" {{ old('machine_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
                        </div>
